...
export const mockLocationHistory: LocationHistory[] = [
  {
    id: '1',
    assetId: '1',
    assignedLocation: 'St. Mary\'s Hospital - ICU',
    actualLocation: 'St. Mary\'s Hospital - ICU',
  ...
  },
  {
    id: '2',
    assetId: '1',
    assignedLocation: 'Main Pharmacy - Storage',
    actualLocation: 'Main Pharmacy - Storage',
  ...
  },
  {
    id: '3',
    assetId: '1',
    assignedLocation: 'Regional Medical Center - Ward 3',
    actualLocation: 'Regional Medical Center - Ward 3',
  ...
  },
  {
    id: '4',
    assetId: '1',
    assignedLocation: 'East Side Pharmacy',
    actualLocation: 'East Side Pharmacy - Receiving',
    arrivalDate: daysAgo(120),
    departureDate: daysAgo(90),
    status: 'At Pharmacy',
  },
  {
    id: '5',
    assetId: '4',
    assignedLocation: 'Valley View Clinic',
    actualLocation: 'Valley View Clinic',
    arrivalDate: daysAgo(7),
    status: 'At Facility',
  },
];
